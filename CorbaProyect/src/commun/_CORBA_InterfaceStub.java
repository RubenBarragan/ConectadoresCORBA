...
public class _CORBA_InterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements commun.CORBA_Interface
{
  ...
  public String insertRow (String ibt, String name, String lugar, String datetime, String password)
  {
            ...
            try {
                ...
                return insertRow (ibt, name, lugar, datetime, password        );
            } finally {
                _releaseReply ($in);
            }
  } // insertRow
  ...
  public String updateRow (String ibt, String lugar, String datetime, String password)
  {
            ...
            try {
                ...
                return updateRow (ibt, lugar, datetime, password        );
            } finally {
                _releaseReply ($in);
            }
  } // updateRow
  ...
  public void recoveryBD (String ibt, String name, String lugar, String datetime, String password)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                recoveryBD (ibt, name, lugar, datetime, password        );
            } finally {
                _releaseReply ($in);
            }
  } // recoveryBD
